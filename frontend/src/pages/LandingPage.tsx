...
const LandingPage = () => {
  ...
  const features = [
    { icon: Brain, title: t('landing.features.ai.title') || 'AI-Powered Monitoring', desc: t('landing.features.ai.desc') || 'Intelligent agents track patient health 24/7 and flag concerns automatically.' },
    { icon: Activity, title: t('landing.features.vitals.title') || 'Real-Time Vitals', desc: t('landing.features.vitals.desc') || 'Live dashboards with health metrics, risk scores, and trend analysis.' },
    { icon: Shield, title: t('landing.features.alerts.title') || 'Emergency Alerts', desc: t('landing.features.alerts.desc') || 'Instant notifications when critical thresholds are breached.' },
    { icon: Clock, title: t('landing.features.meds.title') || 'Medication Tracking', desc: t('landing.features.meds.desc') || 'Automated reminders and adherence monitoring for every patient.' },
    { icon: Heart, title: t('landing.features.checkins.title') || 'Daily Check-ins', desc: t('landing.features.checkins.desc') || 'Voice and text-based check-ins to capture patient well-being.' },
    { icon: Users, title: t('landing.features.connect.title') || 'Doctor-Patient Connect', desc: t('landing.features.connect.desc') || 'Seamless communication between care teams and patients.' },
  ];

  const steps = [
    { num: '01', title: t('landing.howItWorks.step1.title') || 'Patient Enrolls', desc: t('landing.howItWorks.step1.desc') || 'Patients register and receive a unique ID for their care journey.' },
    { num: '02', title: t('landing.howItWorks.step2.title') || 'Doctor Creates Course', desc: t('landing.howItWorks.step2.desc') || 'Doctors set up personalized medical courses with medications and schedules.' },
    { num: '03', title: t('landing.howItWorks.step3.title') || 'AI Monitors Daily', desc: t('landing.howItWorks.step3.desc') || 'Our agent conducts daily check-ins and monitors all health data.' },
    { num: '04', title: t('landing.howItWorks.step4.title') || 'Alerts & Action', desc: t('landing.howItWorks.step4.desc') || 'Critical changes trigger instant alerts for immediate medical response.' },
  ];

  const stats = [
    { value: '10k+', label: t('landing.stats.patients') || 'Patients', icon: Users },
    { value: '500+', label: t('landing.stats.doctors') || 'Doctors', icon: Heart },
    { value: '99.9%', label: t('landing.stats.uptime') || 'Uptime', icon: Shield },
  ];
      ...
      <footer className="border-t border-border/50 py-8 sm:py-12">
        <div className="container mx-auto px-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <p className="text-xs sm:text-sm text-muted-foreground">© 2025 CARENETRA. {t('landing.footer.rights') || 'All rights reserved.'}</p>
          </div>
        </div>
      </footer>
    </div>
