...
const ImpactDetector = ({ patientName, patientPhone, userId }: any) => {
  ...
  // 3. Core detection logic (unchanged)
  useEffect(() => {
  ...
  const statusBg = sensorsEnabled ? 'emerald-500/10' : 'muted/20';
  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        `}
      >
        {/* Shield icon + pulsing dot if active */}
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <button
                ...
                className={`
                  ...
                  ${sensorsEnabled ? 'bg-emerald-500' : 'bg-muted-foreground/30'}
                `}
                role="switch"
              ...
              >
                <motion.span
                  ...
                  className={`
                    ...
                    ${sensorsEnabled ? 'translate-x-[18px]' : 'translate-x-0.5'}
                  `}
                />
              </button>
            </div>

            {/* Test SOS button – only when active */}
            {sensorsEnabled && (
              <motion.button
